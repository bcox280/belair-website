...
>(({ className, children, title, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'group overflow-auto rounded-xl border bg-card text-card-foreground shadow duration-500 animate-in zoom-in hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary',
      className
    )}
    {...props}
  >
